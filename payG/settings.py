...
SECRET_KEY = 'django-insecure-mr#yr*@ppe^%q$te3qe=i=jc6mmr0vy$(w6qxtz9k$dw7)kjrr'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(TEMPLATE_BASE_DIR, 'templates'),
                 os.path.join(TEMPLATE_BASE_DIR, 'main/templates'), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',
    os.path.join(TEMPLATE_BASE_DIR, 'main/static'),
]
